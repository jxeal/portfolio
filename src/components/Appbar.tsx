...
export default function Appbar() {
  ...
  return (
    <header
      className="sticky top-0 z-[100] appbar-container flex justify-between items-center px-4 pt-3 pb-2 mb-2 bg-white/50 dark:bg-black/50 rounded-b-xl max-w-[100dvw] md:max-w-[780px] mx-auto font-['Clash_Display']"
      style={{
