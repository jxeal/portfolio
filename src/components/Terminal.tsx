  ...
  return (
    <div className="terminal">
      ...
      <div className="terminal-window bg-terminal rounded-b-md px-6 py-3 h-fit text-white overflow-y-auto items-end ">
        <TypingAnimation
          className="lg:text-xl lg:leading-8 md:text-xl text-base leading-7 font-mono whitespace-pre-wrap text-accent"
          style={{
            whiteSpace: "pre-wrap",
        ...
        <div className="space-y-2">
          <div>
            <div className="lg:text-xl lg:leading-8 md:text-xl text-base leading-7 font-mono whitespace-pre-wrap font-bold text-accent">
              Location:
            </div>
            <TypingAnimation
              className="lg:text-xl lg:leading-8 md:text-xl text-base leading-7 font-mono whitespace-pre-wrap pl-4"
              style={{
                whiteSpace: "pre-wrap",
                wordBreak: "break-word",
              }}
